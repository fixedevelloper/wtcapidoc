...
Route::domain('secure.agensic.com')->group(function () {
    ...
    Route::match(["POST", "GET"], '/notifyurl/paydunya', [StaticSecureController::class, 'notifyPaydunnya'])->name('secure.notifyPaydunnya');
...
Route::match(["POST", "GET"], '/logout', [SecurityAdminController::class, 'logout'])->name('admin.logout');
    Route::group(['middleware' => ['isAdmin']], function () {
        ...
        Route::match(["POST", "GET"], '/customers/{id}/banned', [SettingController::class, 'bannedAccount',])->name('admin.bannedAccount');
