...
return [
    ...
    */
    ...
    'WACEPAY_URL' => env('WACEPAY_URL'),
    'WACEPAY_PASSWORD' => env('WACEPAY_PASSWORD'),
    'WACEPAY_USERNAME' => env('WACEPAY_USERNAME'),
    'PAYDUNYA_PRINCIPAL' => env('PAYDUNYA_PRINCIPAL'),
    'PAYDUNYA_PUBLIC_KEY' => env('PAYDUNYA_PUBLIC_KEY'),
    'PAYDUNYA_SECRET_KEY' => env('PAYDUNYA_SECRET_KEY'),
    'PAYDUNYA_TOKEN' => env('PAYDUNYA_TOKEN'),
    'PAYDUNYA_URL' => env('PAYDUNYA_URL'),
];
