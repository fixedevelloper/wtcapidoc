                    ...
                    <div class="nk-block-between g-3">
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des text-soft">
                                <p>You have total {{count($withdraws)}} items.</p>
                            </div>
                        ...
                        <div class="nk-block-head-content">
                            <ul class="nk-block-tools g-3">
                                <li>
                                    <div class="drodown">
                                        <a href="#" class="btn btn btn-primary" ><em class="icon ni ni-plus"></em>Add withdraw</a>
                ...
                <div class="nk-block">
                    <div class="card card-bordered card-stretch">
                        <div class="card-inner-group">
                            <div class="card-inner">
                                <div class="card-title-group">
                                    <div class="card-title">
                                        <h5 class="title">All withdraw</h5>
                                    </div>
                            ...
                            <div class="card-inner p-0">
                                <div class="nk-tb-list nk-tb-ulist">
                                    <div class="nk-tb-item nk-tb-head">
                                        ...
                                        <div class="nk-tb-col tb-col-lg"><span class="sub-text">Charge</span></div>
                                    ...
                                    @foreach($withdraws as $item)
                                        <div class="nk-tb-item">
                                            ...
                                            <div class="nk-tb-col tb-col-md">
                                                <span>{{number_format($item['charge'],2)}} XAF</span>
                                            </div>
                            ...
                            <div class="card-inner">
                                {{$withdraws->links('vendor.pagination.custom-paginator')}}
                            </div><!-- .card-inner -->
