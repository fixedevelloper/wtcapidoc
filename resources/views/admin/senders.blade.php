    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Senders Lists</h3>
                <div class="nk-block-des text-soft">
                    <p>You have total {{count($senders)}} users.</p>
                </div>
                ...
                <div class="card-inner p-0">
                    <div class="nk-tb-list nk-tb-ulist">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-lg"><span class="sub-text">Civility</span></div>
                            ...
                            <div class="nk-tb-col tb-col-md"><span class="sub-text">Expired Date</span></div>
                                            ...
                                            <div class="drodown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <ul class="link-list-opt no-bdr">
                                                        <li><a href="{{route('admin.sender_detail',['code'=>$item['code']])}}"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
