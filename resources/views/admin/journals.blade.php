    ...
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h3 class="nk-block-title page-title">Journals</h3>
                <div class="nk-block-des text-soft">
                    <p>You have total {{count($journals)}} items.</p>
                </div>
        ...
        <div class="card card-bordered card-stretch">
            <div class="card-inner-group">
                ...
                <div class="card-inner p-0">
                    <div class="nk-tb-list nk-tb-ulist">
                        <div class="nk-tb-item nk-tb-head">
                            ...
                            <div class="nk-tb-col tb-col-mb"><span class="sub-text">Operation</span></div>
                        ...
                        @foreach($journals as $item)
                            <div class="nk-tb-item">
                                ...
                                <div class="nk-tb-col tb-col-mb">
                                    <span class="tb-amount">{{$item->type_operation}} </span>
                                </div>
                                <div class="nk-tb-col tb-col-sm">
                                    <span>{{number_format($item['amount'],2)}} XAF</span>
                                </div>
                                <div class="nk-tb-col tb-col-md">
                                    <span>{{number_format($item['balance_before'],2) }} XAF</span>
                                </div>

                                <div class="nk-tb-col tb-col-md">
                                    <span class="amount">{{number_format($item['balance_after'],2)}} XAF</span>
                                </div>
                                <div class="nk-tb-col tb-col-md">
                ...
                <div class="card-inner">
                    {{$journals->links('vendor.pagination.custom-paginator')}}
                </div><!-- .card-inner -->
