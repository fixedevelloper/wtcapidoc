...
<div class="nk-content-body">
    <div class="nk-block-head nk-block-head-sm">
        <div class="nk-block-between g-3">
            ...
            <div class="nk-block-head-content">
           {{--     <a href="{{route('admin.transactions')}}" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                <a href="{{route('admin.transactions')}}" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
            --}}</div>
        </div>
    </div><!-- .nk-block-head -->
    <div class="nk-block">
        <div class="row gy-5">
            <div class="col-lg-5">
                ...
                <div class="nk-block-head">
                    <div class="nk-block-head-content">
                        <h5 class="nk-block-title title">Info Customer</h5>
                ...
                <div class="card card-bordered">
                    <ul class="data-list is-compact">
                        ...
                        <li class="data-item">
                            <div class="data-col">
                                <div class="data-label">Country</div>
                                <div class="data-value">{{$transaction['country']}}</div>
                            </div>
                        </li>
                        <li class="data-item">
                            <div class="data-col">
                                <div class="data-label">Email</div>
                                <div class="data-value">{{$transaction['customer']['user']['email']}}</div>
                            </div>
                        </li>
                        <li class="data-item">
                            <div class="data-col">
                                <div class="data-label">Phone</div>
                                <div class="data-value">{{$transaction['customer']['phone']}}</div>
                            </div>
                        </li>
                    </ul>
                </div><!-- .card -->
