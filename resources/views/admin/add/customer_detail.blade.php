        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between g-3">
                <div class="nk-block-head-content">
                    <h3 class="nk-block-title page-title">Customer details / <strong class="text-primary small">{{$customer->user->name}}</strong></h3>
                        ...
                        <ul class="data-list is-compact">
                            <li class="data-item">
                                <div class="data-col">
                                    ...
                                    <div class="data-value">{{$customer->user->name}}</div>
                                </div>
                            </li>
                            <li class="data-item">
                                <div class="data-col">
                                    <div class="data-label">Email Address</div>
                                    <div class="data-value">{{$customer->user->email}}</div>
                                </div>
                            </li>
                            <li class="data-item">
                                <div class="data-col">
                                    <div class="data-label">Phone Number</div>
                                    <div class="data-value text-soft">{{$customer->phone}}</div>
                                </div>
                            </li>
                            <li class="data-item">
                                <div class="data-col">
                                    <div class="data-label">Date of Birth</div>
                                    <div class="data-value">{{$customer->date_birth}}</div>
                                </div>
                            </li>
                            <li class="data-item">
                                <div class="data-col">
                            ...
                            <li class="data-item">
                                <div class="data-col">
                                    ...
                                    <div class="data-value">{{$customer->country}}</div>
                                </div>
                            </li>
...
{{--                            <li class="data-item">
                            ...
                            <li class="data-item">
                                <div class="data-col">
                                    <div class="data-label">Balance sandbox</div>
                                    <livewire:UpdateBalanceSandbox :customer="$customer"/>
                                </div>
                            </li>
                            <li class="data-item">
                                <div class="data-col">
                                    <div class="data-label">Balance</div>
                                    <livewire:UpdateBalance :customer="$customer"/>
                                </div>
                            </li>
                        </ul>
                    </div>
