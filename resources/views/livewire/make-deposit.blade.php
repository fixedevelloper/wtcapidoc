<div>
    ...
    @if ($visible)  <div class="components-preview wide-md mx-auto">
        ...
        <div class="nk-block nk-block-lg">
            <div class="card card-bordered">
                <form  wire:submit.prevent="submit" class="nk-stepper stepper-init is-alter nk-stepper-s1"  id="stepper-create-project" style="display: block;" data-step-current="first" novalidate="novalidate">
                                ...
                                <div class="nk-stepper-content">
                                    <div class="nk-stepper-steps stepper-steps">
                                            ...
                                            <div class="row g-3">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input  wire:model.live="name" type="text" class="form-control invalid" id="cp1-project-name" name="cp1-project-name" required="" aria-describedby="cp1-project-name-error">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <select  wire:model.live="country" id="country" required name="country"  class="form-select"  aria-label="Floating label select example">
                                                            ...
                                                            <ul class="custom-control-group">
                                                                <li>
                                                                    <div class="custom-control custom-radio checked">
                                                                        <input  wire:model.live="type_payment" type="radio"
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-radio checked">
                                                                        <input  wire:model.live="type_payment" type="radio" class="custom-control-input valid" name="cp1-project-type" id="cp1-mobil-money-project"
                                                                ...
                                                                <li>
                                                                    <div class="custom-control custom-radio">
                                                                        <input  wire:model.live="type_payment" type="radio"
                                                                                class="custom-control-input valid" name="cp1-project-type"
                                        ...
                                        <div class="nk-stepper-step">
                                            ...
                                            <div class="row g-3">
                                                @if($type_payment=='manuel')
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label class="form-label" for="cp1-project-amount">Amount</label>
                                                            <div class="form-control-wrap">
                                                                <input  wire:model="amount" type="text" class="form-control invalid" id="cp1-project-amount"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            <label class="form-label" for="cp1-project-amount">Phone</label>
                                                            <div class="form-control-wrap">
                                                                <input  wire:model.lazy="phone" type="text" class="form-control invalid" id="cp1-project-phone"
                                                ...
                                                @endif
                                                    @if($type_payment=='mobile_money')
                                                        <h3>COMING SOON</h3>
                                                    @endif
                                                    @if($type_payment=='virement_bank')
                                                    @endif
                                            </div>
                                        </div>
                                {{--        <div class="nk-stepper-step">
                                        ...
                                        <div class="nk-stepper-step text-center">
                                            ...
                                            <p class="text-soft">After creating the deposit you will be redirected to the confirmation page where you will insert a screenshot of the operation</p>
                                                    ...
                                                    <ul class="data-list is-compact">
                                                        ...
                                                        <li class="data-item">
                                                            <div class="data-col">
                                                                ...
                                                                <div class="data-value">{{$country}}</div>
                                                            </div>
                                                        </li>
                                                        <li class="data-item">
                                                            <div class="data-col">
                                                        ...
                                                        <li class="data-item">
                                                            <div class="data-col">
                                                                <div class="data-label">Type deposit</div>
                                                                <div class="data-value">{{$type_payment}}</div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                                </div>
                                    ...
                                    <ul class="nk-stepper-pagination pt-4 gx-4 gy-2 stepper-pagination">
                                        ...
                                        <li class="step-submit" style="display: none;"><button wire:click="submit()"  type="submit" class="btn btn-primary">Submit</button></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
