<div class="nk-sidebar nk-sidebar-fixed is-light" data-content="sidebarMenu">
    <div class="nk-sidebar-element nk-sidebar-head">
        ...
        <div class="nk-sidebar-brand">
            <a href="{{route('sandbox.dashboard')}}" class="logo-link nk-sidebar-logo">
            ...
            <div class="nk-sidebar-menu" data-simplebar>
                <ul class="nk-menu">
                    <li class="nk-menu-item">
                        <a href="{{route('sandbox.dashboard')}}" class="nk-menu-link">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{route('sandbox.senders')}}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-user-list"></em></span>
                            <span class="nk-menu-text">Senders</span><span class="nk-menu-badge">HOT</span>
                        </a>
                    </li><!-- .nk-menu-item -->
             {{--       <li class="nk-menu-item">
                        <a href="{{route('sandbox.beneficiaries')}}" class="nk-menu-link">
                    ...
                    <li class="nk-menu-item">
                        <a href="{{route('sandbox.make_mobil')}}" class="nk-menu-link">
                            <span class="nk-menu-icon"><em class="icon ni ni-mobile"></em></span>
                            <span class="nk-menu-text">Mobil transfer</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-item">
                        <a href="{{route('sandbox.transferList')}}" class="nk-menu-link">
